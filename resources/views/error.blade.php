...
<head>
    ...
    <title>Belanjawan 2027 | Halaman Tidak Ditemukan</title>
    <!-- Custom CSS -->
    ...
    <div class="main-wrapper">
        ...
        <div class="error-box">
            <div class="error-body text-center">
                <h1 class="error-title text-info">😔</h1>
                <h3 class="text-uppercase error-subtitle">Tempoh Hantar Cadangan Belanjawan 2027 Telah Tamat</h3>
                <p class="text-muted m-t-30 m-b-30">Terima kasih.</p>
                {{-- <a href="{{ route('pencadang') }}" class="btn btn-danger btn-rounded waves-effect waves-light m-b-40">Kembali ke halaman utama</a> </div> --}}
        </div>
        <!-- ============================================================== -->
        <!-- Login box.scss -->
        <!-- ============================================================== -->
