...
@section('title', 'Create JKKP')
@section('content')
@include('include.error')
<div class="card">
    <header class="card-header d-flex align-items-center justify-content-between">
        <h5 class="card-title mb-0">Create JKKP</h5>
    </header>
    
    <div class="card-body">
        <form action="{{ route('jkkpmains.store') }}" method="POST" id="create_jkkpmain_form">
            @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="nama_pem" name="nama_pem" placeholder="Nama Pemberitahu" value="{{ old('nama_pem') }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="jaw_pem" name="jaw_pem" placeholder="Jawatan" value="{{ old('jaw_pem') }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="jab_pem" name="jab_pem" placeholder="Jabatan" value="{{ old('jab_pem') }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="tel_pem" name="tel_pem" placeholder="No. Telefon" value="{{ old('tel_pem') }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="id_pem" name="id_pem" placeholder="No. Pekerja" value="{{ old('id_pem') }}">
                                        </div>
                                    </div>
                                </div>
                            {{-- </form> --}}
                        ...
                        <div class="card-body">
                            ...
                            {{-- <form class="form-horizontal p-t-20"> --}}
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="Sila Masukkan No Pekerja" name="id_terlibat" id="paynumber" aria-label="" aria-describedby="basic-addon1" value="{{ old('id_terlibat') }}">
                                ...
                                <div class="form-group row">
                                    <label for="web10" class="col-sm-3 control-label">Ketua Jabatan / Unit / Bahagian<span class="text-danger">*</span></label>
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                            <select class="form-control" id="ketua_jab" name="nama_boss">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="nama_terlibat" name="nama_terlibat" placeholder="Nama Terlibat" readonly value="{{ old('nama_terlibat') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="no_kad_pengenalan_terlibat" name="kp_terlibat" placeholder="No. Kad Pengenalan" readonly value="{{ old('kp_terlibat') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="tarikh_lahir_terlibat" name="tarikh_lahir" placeholder="Tarikh Lahir" readonly value="{{ old('tarikh_lahir') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="warganegara_terlibat" name="warganegara" placeholder="Warganegara" readonly value="{{ old('warganegara') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="jantina_terlibat" name="jantina" placeholder="Jantina" readonly value="{{ old('jantina') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="jawatan_terlibat" name="jawatan" placeholder="Jawatan" readonly value="{{ old('jawatan') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="jabatan_terlibat" name="jabatan" placeholder="Jabatan" readonly value="{{ old('jabatan') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="maklumat_gaji_terlibat" name="gaji" placeholder="Maklumat Gaji (RM)" readonly value="{{ old('gaji') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    <div class="input-group">
                                        ...
                                        <input type="date" class="form-control" id="tarikh_kejadian" name="tarikh_kejadian" placeholder="Tarikh Kemalangan" value="{{ old('tarikh_kejadian') }}">
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="input-group">
                                        <div class="input-group-prepend"><span class="input-group-text"><i class="ti-time"></i></span></div>
                                        <input type="time" class="form-control" id="masa_kejadian" name="masa_kejadian" placeholder="Masa Kemalangan" value="{{ old('masa_kejadian') }}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="lokasi_kejadian" name="lokasi_kejadian" placeholder="Lokasi Kemalangan" value="{{ old('lokasi_kejadian') }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        ...
                                        <textarea class="form-control" id="huraian_sebelum" name="huraian_sebelum" rows="5" placeholder="Sebelum Kejadian..">{{ old('huraian_sebelum') }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        ...
                                        <textarea class="form-control" id="huraian_semasa" name="huraian_semasa" rows="5" placeholder="Semasa Kejadian..">{{ old('huraian_semasa') }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        ...
                                        <textarea class="form-control" id="huraian_selepas" name="huraian_selepas" rows="5" placeholder="Selepas Kejadian..">{{ old('huraian_selepas') }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        fetch('/api/list-kj')
            ...
            .then(data => {
                ...
                data.ketuaJabatan.forEach(item => {
                    ...
                    // value → PAYNUMBER (disarankan untuk simpan ke DB)
                    option.value = item.PER_STAFFNAME;

                    // text → Nama staf + jawatan (lebih jelas untuk user)
                    option.textContent = 
